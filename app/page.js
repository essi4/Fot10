...
export default function HomePage() {
  const quickNav = [["لیگ‌ها", Trophy, "/leagues"], ["تیم ملی", Shield, "/national-teams"], ["برنامه بازی‌ها", CalendarDays, "/matches"], ["آمار و ارقام", BarChart3, "/stats"], ["برترین‌های ماه", Medal, "/players"], ["نقل‌وانتقالات", Repeat2, "/transfers"]];
