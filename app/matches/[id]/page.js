...
function eventIcon(e) { if (e.type === "Goal") return "⚽"; if (e.type === "Card") return e.detail?.toLowerCase().includes("red") ? "🟥" : "🟨"; if (e.type === "subst") return "🔄"; return "•"; }
function eventTitle(e) { if (e.type === "Goal") return e.detail || "گل"; if (e.type === "Card") return e.detail || "کارت"; if (e.type === "subst") return "تعویض"; return e.detail || e.type || "رویداد"; }
