...
function formatProjectDate(value) { return new Date(`${value}T12:00:00+03:30`).toLocaleDateString("fa-IR", { weekday: "short", day: "numeric", month: "short", timeZone: "Asia/Tehran" }); }
