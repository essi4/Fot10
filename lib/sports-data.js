...
export async function getLeagueCurrentSeason(league) {
  ...
  return seasons.find((season) => season.current && season?.coverage?.fixtures?.date && season?.coverage?.standings)?.year
    || seasons.find((season) => season.current && season?.coverage?.fixtures?.date)?.year
