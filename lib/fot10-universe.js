export const CONTINENTS = [
  {
    slug: "asia", name: "آسیا", icon: "🌏",
    countries: [
      ["ایران", "Iran", "🇮🇷", "لیگ برتر ایران", "iran", 195], ["ژاپن", "Japan", "🇯🇵", "J1 League", "j1-league", 98], ["کره جنوبی", "South Korea", "🇰🇷", "K League 1", "k-league-1", 292], ["عربستان", "Saudi Arabia", "🇸🇦", "Saudi Pro League", "saudi-pro-league", 307], ["قطر", "Qatar", "🇶🇦", "Qatar Stars League", "qatar-stars-league", 305], ["امارات", "United Arab Emirates", "🇦🇪", "UAE Pro League", "uae-pro-league", 301], ["چین", "China", "🇨🇳", "Chinese Super League", "chinese-super-league", 169], ["استرالیا", "Australia", "🇦🇺", "A-League Men", "a-league", 188], ["عراق", "Iraq", "🇮🇶", "Iraqi League", "iraqi-league", 495], ["تایلند", "Thailand", "🇹🇭", "Thai League 1", "thai-league-1", null]
    ]
  },
  {
    slug: "europe", name: "اروپا", icon: "🇪🇺",
    countries: [
  ...
  {
    slug: "oceania", name: "اقیانوسیه", icon: "🌊",
    countries: [
      ["نیوزیلند", "New Zealand", "🇳🇿", "National League", "new-zealand-national", null], ["فیجی", "Fiji", "🇫🇯", "National Football League", "fiji-national", null], ["جزایر سلیمان", "Solomon Islands", "🇸🇧", "S-League", "solomon-islands-sleague", null], ["تاهیتی", "Tahiti", "🇵🇫", "Ligue 1", "tahiti-ligue-1", null], ["کالدونیای جدید", "New Caledonia", "🇳🇨", "Super Ligue", "new-caledonia-super", null], ["پاپوآ گینه نو", "Papua New Guinea", "🇵🇬", "National Soccer League", "png-national", null], ["وانواتو", "Vanuatu", "🇻🇺", "Port Vila Premier League", "vanuatu-premier", null], ["ساموآ", "Samoa", "🇼🇸", "Samoa National League", "samoa-national", null], ["تونگا", "Tonga", "🇹🇴", "Tonga Major League", "tonga-major", null], ["جزایر کوک", "Cook Islands", "🇨🇰", "Round Cup", "cook-islands-round", null]
    ]
  }
].map((continent) => ({
  ...continent,
...
export const CLUB_CUPS = [
  { name: "لیگ قهرمانان اروپا", slug: "ucl", country: "اروپا · باشگاهی", icon: "⭐", id: 2, leagueId: 2, continent: "europe" },
  ...
  { name: "لیگ قهرمانان آسیا نخبگان", slug: "afc-champions-league-elite", country: "آسیا · باشگاهی", icon: "👑", id: 17, leagueId: 17, continent: "asia" },
  ...
  { name: "کوپا سودامریکانا", slug: "copa-sudamericana", country: "آمریکای جنوبی · باشگاهی", icon: "🥈", continent: "south-america" },
