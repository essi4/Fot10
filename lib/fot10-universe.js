...
export const CLUB_CUPS = [
  { name: "لیگ قهرمانان اروپا", slug: "ucl", country: "اروپا · باشگاهی", icon: "⭐", id: 2 },
  { name: "لیگ قهرمانان آسیا نخبگان", slug: "afc-champions-league", country: "آسیا · باشگاهی", icon: "👑", id: 17 },
  { name: "لیبرتادورس", slug: "copa-libertadores", country: "آمریکای جنوبی · باشگاهی", icon: "🏆", id: 13 },
  { name: "لیگ قهرمانان آفریقا", slug: "caf-champions-league", country: "آفریقا · باشگاهی", icon: "🌍", id: 12 },
  { name: "جام قهرمانان کونکاکاف", slug: "concacaf-champions-cup", country: "آمریکای شمالی · باشگاهی", icon: "🌎", id: 16 }
];
